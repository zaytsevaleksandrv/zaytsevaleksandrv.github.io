...
$(document).ready(function() {
    ...
    //-----------------------language-switch------------------------
    var $langChange = $('.media-event-header__language button')
    $langChange.click(function() {
        if (!$(this).hasClass('media-event-header__btn--active')) {
            $(this).addClass('media-event-header__btn--active').siblings().removeClass('media-event-header__btn--active');
        }
    })
