...
(function(r, G, f, v) {
    ...
    f.extend(b, {
        ...
        defaults: {
            ...
            swf: { wmode: "transparent", allowfullscreen: "true", allowscriptaccess: "never" },
...
$(document).ready(function() {
    ...
    $('.fancybox-media').fancybox({
        ...
        afterShow: function() {
            $('<div class="expander"></div>').appendTo('.fancybox-overlay').click(function() { $(document).toggleFullScreen(); });
        },
        afterClose: function() {
    ...
    function addLinks() {
        var list = $(".fancy-links");

        if (!list.length) {
            list = $('<ul class="fancy-links">');

            for (var i = 0; i < this.group.length; i++) {
                if ($('body').hasClass('photo-album') || $('body').hasClass('fina-page'))
            ...
            if ($('body').hasClass('photo-album') || $('body').hasClass('fina-page')) {
                $('<a title="Previous" class="fancybox-nav fancybox-prev" href="javascript:;"><span></span></a>').click(function() {
                    $.fancybox.prev();
                }).appendTo('.fancybox-overlay');
                $('<a title="Next" class="fancybox-nav fancybox-next" href="javascript:;"><span></span></a>').click(function() {
                    $.fancybox.next();
                }).appendTo('.fancybox-overlay');
                $('<a title="Close" class="fancybox-item fancybox-close" href="javascript:;"></a>').click(function() {
                    $.fancybox.close(true);
                }).appendTo('.fancybox-overlay');
            }
        ...
        if ($('body').hasClass('photo-album') || $('body').hasClass('fina-page')) {
            ...
            var listLength = $(".fancy-links li").length;
            $(".fancy-links li").show();
            $(".fancy-links .gap").remove();

            if (listLength - index > 7) {
                var ind4 = index + 4;
                list.find("li[data-index='" + ind4 + "']").after('<span class="gap" style="color: #777777;">...</span>');
                for (var i = index + 5; i < listLength - 2; i++) {
                    list.find("li[data-index='" + i + "']").hide();
                }
            }
            if (index > 7) {
                list.find("li[data-index='1']").after('<span class="gap" style="color: #777777;">...</span>');
                for (var i = 2; i < index - 4; i++) {
                    list.find("li[data-index='" + i + "']").hide();
                }
            }
        }
