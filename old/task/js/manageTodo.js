...
*/
    ...
    function showAllTodo(todo_item, todo_due_date, todo_id) {
        $('ul.list').append(
            '<li><table><tr><td style="width: 60%"><div class="todo_item"><span class="todo_text">' + todo_item + '</span></td>' +
            '<td><span class="due_date">' + todo_due_date + '</span></td>' +
            '<td><input id="this_id" value="' + todo_id +
            '" type="hidden"></td><td><a href="#" id="delete"> Удалить </a></td><td><a href="#" id="create"> Изменить </a><div class="clear"></div></div></td></tr></table></li>');
        $('li:last').addClass('highlight').delay(1000).queue(function(next) {
