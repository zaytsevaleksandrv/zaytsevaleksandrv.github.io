...
const MAX_DECRIPTION_LENGTH = 100;

const HotelCard = React.createClass({
    render(){
         /*дестуризация объектов*/
   const {
        id,
        name,
        image,
            ...
            <div className="hotel-card">
                ...
                <div className="hotel-body">
                    ...
                    <p className="hotel-description">
                        {
                            description.length > MAX_DECRIPTION_LENGTH
                            ? description.substring(0, MAX_DECRIPTION_LENGTH) + '...'
                            : description
                        }
                    </p>
                </div>
...
const HotelApp = React.createClass({
    ...
    render(){       
    const hotelCards = this.state.displayHotels.map(hotel => 
        <HotelCard
            key = {hotel.id}
            id = {hotel.id}
            name = {hotel.name}
